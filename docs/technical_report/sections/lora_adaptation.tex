...
\begin{table}[H]
  ...
  \begin{tabular}{cccccc}
    ...
    \midrule
    Frozen & 0 & \textit{[baseline]} & \textit{[baseline]} & \textit{[baseline]} & \textit{[baseline]} \\
    2  & $\sim$49K  & \textit{[to fill]} & \textit{[to fill]} & \textit{[to fill]} & \textit{[to fill]} \\
    4  & $\sim$99K  & \textit{[to fill]} & \textit{[to fill]} & \textit{[to fill]} & \textit{[to fill]} \\
    8  & $\sim$197K & \textit{[to fill]} & \textit{[to fill]} & \textit{[to fill]} & \textit{[to fill]} \\
    16 & $\sim$394K & \textit{[to fill]} & \textit{[to fill]} & \textit{[to fill]} & \textit{[to fill]} \\
    32 & $\sim$787K & \textit{[to fill]} & \textit{[to fill]} & \textit{[to fill]} & \textit{[to fill]} \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{lccc}
    ...
    \midrule
    LoRA ($r=8$) & \textit{[to fill]} & \textit{[to fill]} & \textit{[to fill]} \\
    DoRA ($r=8$) & \textit{[to fill]} & \textit{[to fill]} & \textit{[to fill]} \\
    \bottomrule
  \end{tabular}
\end{table}
