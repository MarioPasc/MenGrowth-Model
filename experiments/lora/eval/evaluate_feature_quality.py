#!/usr/bin/env python
# experiments/lora/eval/evaluate_feature_quality.py
...
Usage:
    python -m experiments.lora.eval.evaluate_feature_quality \
        --config experiments/lora/config/ablation_v3.yaml \
