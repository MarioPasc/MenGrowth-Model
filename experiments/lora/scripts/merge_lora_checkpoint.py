...
Usage:
    python -m experiments.lora.scripts.merge_lora_checkpoint \
...
from src.growth.models.encoder.swin_loader import load_full_swinunetr
...
def merge_and_save(
    ...
    lora_model = LoRASwinViT.load_lora(base_model, adapter_dir, device="cpu", trainable=False)
...
def main():
    ...
    parser.add_argument("--use-dora", action="store_true", help="Adapter uses DoRA")
