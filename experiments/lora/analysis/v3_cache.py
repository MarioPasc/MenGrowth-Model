#!/usr/bin/env python
# experiments/lora/analysis/v3_cache.py
...
Usage:
    from experiments.lora.analysis.v3_cache import precompute_all
...
def _build_dice_data(
    ...
    """Consolidate test_dice_men.json per condition.

    Returns:
        Dict mapping condition name to ``{"men": {...}}``.
    """
    data: dict[str, Any] = {}
    for cond_cfg in config["conditions"]:
        name = cond_cfg["name"]
