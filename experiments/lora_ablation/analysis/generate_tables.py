...
def generate_comprehensive_latex(
    ...
    Format:
    | Condition | BraTS-MEN Dice | BraTS-GLI Dice | Linear R2 | GP-RBF R2 | Params |
    ...
    lines = [
        ...
        r"and glioma (out-of-domain) test sets. Linear and GP-RBF probe $R^2$ measure semantic feature "
