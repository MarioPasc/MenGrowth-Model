...
def generate_comprehensive_latex(
    ...
    Format:
    | Condition | BraTS-MEN Dice | Linear R2 | GP-RBF R2 | Params |
    |           | Mean TC WT ET  | V L S mu  | V L S mu  | Tot Trn|
    """
    lines = [
        ...
        r"\begin{tabular}{l|cccc|cccc|cccc|rr}",
        r"\toprule",
        r" & \multicolumn{4}{c|}{BraTS-MEN Dice} "
        r"& \multicolumn{4}{c|}{Linear $R^2$} & \multicolumn{4}{c|}{GP-RBF $R^2$} & \multicolumn{2}{c}{Params} \\",
        r"Condition & Mean & TC & WT & ET "
    ...
    for cond in config["conditions"]:
        ...
        r2_vol_rbf = fmt_r2(m.get("r2_volume_rbf"))
        r2_loc_rbf = fmt_r2(m.get("r2_location_rbf"))
        r2_shp_rbf = fmt_r2(m.get("r2_shape_rbf"))
        r2_mean_rbf = fmt_r2(m.get("r2_mean_rbf"))
        ...
        row = (
            ...
            f"{r2_vol_rbf} & {r2_loc_rbf} & {r2_shp_rbf} & {r2_mean_rbf} & "
