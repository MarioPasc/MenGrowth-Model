#!/usr/bin/env python
# experiments/lora_ablation/visualizations_v2.py
"""Enhanced visualizations for LoRA ablation analysis.

Key improvements:
1. UMAP colored by semantic features (volume, location)
2. Variance per dimension plots
3. Prediction vs ground truth scatter plots
4. Linear vs MLP R² comparison
5. Publication-quality figures

Usage:
    python -m experiments.lora_ablation.visualizations_v2 \
