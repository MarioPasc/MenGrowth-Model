#!/usr/bin/env python
# experiments/lora_ablation/evaluate_probes_v2.py
"""Enhanced probe evaluation with MLP probes and target normalization.

Key improvements:
1. Both linear AND MLP probes for complete analysis
2. Target normalization for stable evaluation
3. Multi-scale feature support
4. Detailed diagnostics and variance analysis

Usage:
    python -m experiments.lora_ablation.evaluate_probes_v2 \
