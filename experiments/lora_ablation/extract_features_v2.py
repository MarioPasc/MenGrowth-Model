#!/usr/bin/env python
# experiments/lora_ablation/extract_features_v2.py
"""Enhanced feature extraction with multi-scale support.

Key improvements:
1. Multi-scale features: concatenate layers2+3+4 (1344-dim total)
2. Better handling of merged LoRA weights
3. Separate storage for single-scale and multi-scale features

Usage:
    python -m experiments.lora_ablation.extract_features_v2 \
