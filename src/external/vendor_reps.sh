...
# --- 1. BrainSegFounder (JAX/Original) ---
vendor_repo "https://github.com/lab-smile/BrainSegFounder.git" "BrainSegFounder" "BrainSegFounder (JAX/Original)"
...
echo "   - BrainSegFounder/    (JAX/Original reference)"
