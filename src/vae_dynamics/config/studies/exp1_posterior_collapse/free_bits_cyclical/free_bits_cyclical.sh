...
# ========================================================================
EXPERIMENT_NAME="free_bits_cyclical"
...
CONFIG_FILE="${REPO_SRC}/src/vae_dynamics/config/studies/exp1_posterior_collapse/free_bits_cyclical/free_bits_cyclical.yaml"
