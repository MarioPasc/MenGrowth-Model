...
# ========================================================================
EXPERIMENT_NAME="cyclical_annealing"
...
CONFIG_FILE="${REPO_SRC}/src/vae_dynamics/config/studies/exp1_posterior_collapse/cyclical_annealing/cyclical_annealing.yaml"
